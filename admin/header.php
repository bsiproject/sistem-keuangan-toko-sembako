...
<head>
  ...
  <title>Administrator - Sistem Informasi Keuangan Toko Sembako</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        <span class="logo-mini"><b>Toko Sembako</b> </span>
        <span class="logo-lg"><b>Bunda</b>Laxana</span>
      </a>
          ...
          <li>
           ...
           <li class="treeview">
            ...
            <ul class="treeview-menu" style="display: none;">
              <li><a href="uangkeluar.php"><i class="fa fa-circle-o"></i> Uang Keluar</a></li>
              <li><a href="gajianggota.php"><i class="fa fa-circle-o"></i> Gaji Anggota</a></li>
            </ul>
          </li>
